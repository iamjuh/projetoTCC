...
namespace LojaTCC
{
    class Clncliente
    {
        ...
        public DataSet Listar(string strDescricao)
        {
            ...
            strQuery = "Select * from Cliente where nome like '%" + strDescricao +
                "%'";
        ...
        public OracleDataReader ListarUsuario(string cod)
        {
            ...
            string strQuery = "Select * from Cliente where cod_Cliente='" + CodCliente + "'";
            clnBancodeDados ObjBancoDados = new clnBancodeDados();
        ...
        public void Alterar()
        {
            ...
            strQuery += (" WHERE ");
            strQuery += (" cod_Cliente = '" + _CodCliente + "' ");
            clnBancodeDados ObjBancoDados = new clnBancodeDados();
            ObjBancoDados.ExecutaComando(strQuery);
